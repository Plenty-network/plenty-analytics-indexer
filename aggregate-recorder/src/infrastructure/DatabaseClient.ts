    ...
    try {
      ...
      await this._dbClient.query(
        `CREATE TABLE IF NOT EXISTS transaction (
          ...
          token_1_amount numeric(24, 12) NOT NULL,
          token_2_amount numeric(24, 12) NOT NULL,
      ...
      await this._dbClient.query(
        `CREATE TABLE IF NOT EXISTS plenty_aggregate_hour (
          ...
          volume_value numeric(24, 12) NOT NULL,
          fees_value numeric(24, 12) NOT NULL
        );`
      );
      ...
      await this._dbClient.query(
        `CREATE TABLE IF NOT EXISTS pool_aggregate_hour (
          ts BIGINT,
          pool varchar,
          token_1_volume numeric(24, 12) NOT NULL,
          token_1_volume_value numeric(24, 12) NOT NULL,
          token_2_volume numeric(24, 12) NOT NULL,
          token_2_volume_value numeric(24, 12) NOT NULL,
          token_1_fees numeric(24, 12) NOT NULL,
          token_1_fees_value numeric(24, 12) NOT NULL,
          token_2_fees numeric(24, 12) NOT NULL,
          token_2_fees_value numeric(24, 12) NOT NULL,
          token_1_locked numeric(24, 12) NOT NULL,
          token_1_locked_value numeric(24, 12) NOT NULL,
          token_2_locked numeric(24, 12) NOT NULL,
          token_2_locked_value numeric(24, 12) NOT NULL,
          PRIMARY KEY (ts, pool)
        );`
      );
