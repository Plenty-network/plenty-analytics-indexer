...
export const REMOVE_LIQUIDITY_ENTRYPOINTS = ["remove_liquidity", "RemoveLiquidity"];
export const TXN_ENTRYPOINTS = [...SWAP_ENTRYPOINTS, ...ADD_LIQUIDITY_ENTRYPOINTS, ...REMOVE_LIQUIDITY_ENTRYPOINTS];
